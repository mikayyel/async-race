                ...
                if (driveData?.success) {
                    ...
                    const timeoutId = setTimeout(() => {
                        ...
                        if (!winnerRef.current) {
                            ...
                            console.log(`Winner: ${cars[index].name}`, `data: ${winnerRef.current}`, `Time: ${timeToFinish}`);
                            console.log(winners);
        ...
        {cars.map((car) => (
            <div key={car.id} className={style.div}>
              ...
              <div className={style.carBtns}>
                ...
                <button
                  onClick={() => handleStart(car)}
                  disabled={carsData[car.id]?.drive}
                >
                  Start
                </button>
                <button
                  onClick={() => handleStop(car)}
                  disabled={!carsData[car.id]?.drive}
                >
                  Stop
                </button>
